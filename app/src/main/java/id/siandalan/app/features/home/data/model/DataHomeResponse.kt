...
data class DataHomeResponse(
    ...
    fun toDomain(): HomeItem {
        return HomeItem(
            ...
            dataDrafted = this.total?.dataDrafted?.map { dataApproved ->
            ...
            docDrafted = this.total?.docDrafted?.map { docDrafted ->
                HomeItem.DocumentItem(
                    id = docDrafted?.idAndalalin,
                    name = docDrafted?.name,
                    fileName = docDrafted?.fileName,
                )
            },
            docApprove = this.total?.docApproved?.map { docApproved ->
                HomeItem.DocumentItem(
                    id = docApproved?.idAndalalin,
                    name = docApproved?.name,
                    fileName = docApproved?.fileName,
                )
            },
        )
    }
